...
Phase 5.1 added a preview decode readiness contract. Under the installed local alpha source contract, JPEG/JPG rows can be marked ready by reference, while RAW, PNG, TIFF, HEIC, database, sidecar-like, and other unsupported rows return a clear unsupported state in the product preview route.
