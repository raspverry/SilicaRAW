...
- JPEG/JPG thumbnail, loupe preview, Develop preview, exposure/contrast, white balance, tone recovery, color presence, edit-state persistence, and JPEG sRGB export path
