...
- JPEG/JPG thumbnail, loupe preview, Develop preview, histogram, exposure/contrast, white balance, tone recovery, color presence, reset, built-in presets, edit-state persistence, and JPEG/PNG/TIFF export paths
