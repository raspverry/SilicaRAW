...
- Phase 18 task cards exist. Tasks 18.1.1 through 18.4.1 are complete. Current next task is [Task 18.4.2 Geometry Preview and Export Parity](../tasks/18.4.2-geometry-preview-export-parity.md).
...
1. Start [Task 18.4.2 Geometry Preview and Export Parity](../tasks/18.4.2-geometry-preview-export-parity.md).
