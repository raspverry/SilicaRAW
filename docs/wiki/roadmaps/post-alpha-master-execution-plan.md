...
- Phase 18 task cards exist. Tasks 18.1.1 through 18.1.3 are complete. Current next task is [Task 18.2.1 HSL Color Mixer Mutators](../tasks/18.2.1-hsl-color-mixer-mutators.md).
...
1. Start [Task 18.2.1 HSL Color Mixer Mutators](../tasks/18.2.1-hsl-color-mixer-mutators.md).
