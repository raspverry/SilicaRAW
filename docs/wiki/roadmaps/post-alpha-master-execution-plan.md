...
- Tasks 17.1.1 through 17.2.2 are complete.
- Next task: [17.2.3 Color Presence Preview Commit Export Parity](../tasks/17.2.3-color-presence-preview-commit-export-parity.md).
...
1. Execute Task 17.2.3 from the existing task card.
