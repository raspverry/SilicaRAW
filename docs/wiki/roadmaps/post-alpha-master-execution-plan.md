...
- Phase 18 task cards exist. Tasks 18.1.1 through 18.2.2 are complete. Current next task is [Task 18.2.3 HSL Panel UI and QA](../tasks/18.2.3-hsl-panel-ui-qa.md).
...
1. Start [Task 18.2.3 HSL Panel UI and QA](../tasks/18.2.3-hsl-panel-ui-qa.md).
