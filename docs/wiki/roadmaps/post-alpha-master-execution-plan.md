...
- Phase 14 is active.
- Task 14.0 through Task 14.4 are complete.
- Next task: [14.5 Viewer Input Ownership Proof](../tasks/14.5-viewer-input-ownership-proof.md).
...
1. Execute Task 14.5 from the existing task card.
