...
- Phase 18 task cards exist. Tasks 18.1.1 through 18.2.1 are complete. Current next task is [Task 18.2.2 HSL Preview, Commit, and Export Parity](../tasks/18.2.2-hsl-preview-commit-export-parity.md).
...
1. Start [Task 18.2.2 HSL Preview, Commit, and Export Parity](../tasks/18.2.2-hsl-preview-commit-export-parity.md).
