...
- Phase 14 is active.
- Task 14.0 is complete.
- Next task: [14.1 AppKit/Metal Viewer Bridge Contract](../tasks/14.1-appkit-metal-viewer-bridge-contract.md).
...
1. Execute Task 14.1 from the existing task card.
