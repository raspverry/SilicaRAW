...
- Phase 14 is active.
- Task 14.0 and Task 14.1 are complete.
- Next task: [14.2 Native Viewer Feature Gate and Module Shell](../tasks/14.2-native-viewer-feature-gate.md).
...
1. Execute Task 14.2 from the existing task card.
