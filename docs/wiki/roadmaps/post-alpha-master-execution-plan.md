...
- Phase 18 is complete. Phase 19 task cards exist. Tasks 19.1 through 19.3 are complete. Current next task is [Task 19.4 Mask Compositing in Preview and Export](../tasks/19.4-mask-compositing-preview-export.md).
...
1. Start [Task 19.4 Mask Compositing in Preview and Export](../tasks/19.4-mask-compositing-preview-export.md).
