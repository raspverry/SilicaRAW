...
- Phase 18 task cards exist. Tasks 18.1.1 and 18.1.2 are complete. Current next task is [Task 18.1.3 Tone Curve Panel UI and QA](../tasks/18.1.3-tone-curve-panel-ui-qa.md).
...
1. Start [Task 18.1.3 Tone Curve Panel UI and QA](../tasks/18.1.3-tone-curve-panel-ui-qa.md).
