...
- The Phase 29-36 implementation route in the [LUT and Video Service Master Plan](../roadmaps/lut-video-service-master-plan.md) is active and local-first; distribution remains blocked. Task 29.0 is complete through [ADR 0011](../decisions/adr-0011-service-direction-charter.md), Task 29.1 is complete, and Task 29.2 is the default next sequential product-development task. Other Phase 29 branches remain governed by the existing DAG, and Phase 30 waits for all Phase 29 tasks. Q6.3/Q6.4 remain open, Task 27.2 remains blocked, Phase 28 has not started, and unsigned DMGs remain developer-preview-only.
