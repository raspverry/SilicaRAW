...
- The desktop `query_library_photos` command accepts a typed page/sort/filter DTO and returns `photoGridPage` metadata. UI consumption is still a later task.
