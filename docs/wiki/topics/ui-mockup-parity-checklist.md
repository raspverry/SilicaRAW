...
| Develop | `MockupUI/M005_Develop_default.png`, `M013`, `M014` | `desktop-1440-M005-develop.png`, `M017`, `M028` | P0 | Q2.4 adds explicit unsupported Develop evidence with no preview image and unsupported mask copy. Q2.5 aligns right-panel rhythm and verifies ready Develop mask support copy stays `Manual`. Q2.6 opens History evidence on the readable history panel and keeps blocked/future readback quieter than the preview workflow. |
| Export Dialog | `MockupUI/M007_Export_Dialog.png`, `M015`, `M016` | `desktop-1440-M007-export.png`, `M022` | P1 | Q2.5 lowers Export summary and recent-export heading weight, aligns label/value rhythm, normalizes two-line selection card height, and separates batch failure file names from block reasons. Q2.6 keeps Display P3 field, summary, and safety copy coherent in the batch workflow state. |
| Preferences Appearance | `MockupUI/M008_Preferences_Appearance.png` | `desktop-1440-M020-preferences-appearance.png`, `M021` | P2 | Current scope is intentionally smaller than the mockup. Q2.5 aligns Preferences two-line section selectors and disabled control weight with Export and inspector rhythm. Q2.6 compacts Advanced disabled permission contracts so future gates stay visible without clipping. |
...
| AI Review | `MockupUI/M010_AI_Review.png` | `desktop-1440-M023-ai-review.png`, `M024` | P0 | Q2.6 reduces review-only banner, selected-card, and approval-action emphasis while preserving non-mutating copy and explicit approval gates. Broader AI review workflow changes remain out of local alpha Q2 scope. |
...
| Q2.6 Resolve Known Visual Contradictions | M007, M008, M010, plus M017/M021/M022/M023/M024 | Completed: fix Display P3 export copy coherence, Advanced clipping, History evidence alignment, and AI Review over-emphasis without adding new product features. |
