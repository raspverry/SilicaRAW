...
Do not implement RAW decoding merely because Spike 002 selected Core Image primary. The next decoder work must be fixture-backed and explicitly scoped. Do not add LibRaw or a Rust binding without updating `docs/DEPENDENCIES.md`.
