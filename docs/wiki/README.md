...
`docs/wiki/` contains SilicaRAW's public, LLM-readable wiki.

The wiki is designed for contributors and agents. It gives orientation, records decisions, tracks risks, and connects external sources to the project's current direction.
