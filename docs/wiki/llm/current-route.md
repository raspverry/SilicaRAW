...
| --- | --- |
| Product development | The Phase 29-36 implementation route in the [LUT and Video Service Master Plan](../roadmaps/lut-video-service-master-plan.md) is active. Task 29.0 is complete through [ADR 0011](../decisions/adr-0011-service-direction-charter.md). Task 29.1 is the default next task; other Phase 29 branches may start only when the Phase 29 DAG permits them. Phase 30 waits for all Phase 29 tasks. |
...
- The selected Phase 29 task card; default to [Task 29.1](../tasks/29.1-detail-ui-regression-truth-audit.md).
