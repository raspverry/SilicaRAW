...
| --- | --- |
| Product development | The Phase 29-36 implementation route in the [LUT and Video Service Master Plan](../roadmaps/lut-video-service-master-plan.md) is active. Tasks 29.0 through 29.6 are complete as of 2026-07-11. Task 29.7: Extract Frontend Modules is the default next sequential product-development task; other Phase 29 branches remain governed by the existing DAG. Phase 30 waits for all Phase 29 tasks. |
...
- The selected Phase 29 task card; default to [Task 29.7: Extract Frontend Modules](../tasks/29.7-extract-frontend-modules.md).
