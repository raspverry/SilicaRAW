...
| --- | --- |
| Product development | The Phase 29-36 implementation route in the [LUT and Video Service Master Plan](../roadmaps/lut-video-service-master-plan.md) is active. Task 29.0 is complete through [ADR 0011](../decisions/adr-0011-service-direction-charter.md), and Task 29.1 is complete. Task 29.2 is the default next sequential product-development task; other Phase 29 branches remain governed by the existing DAG. Phase 30 waits for all Phase 29 tasks. |
...
- The selected Phase 29 task card; default to [Task 29.2: ICC Profile Portability](../tasks/29.2-icc-profile-portability.md).
