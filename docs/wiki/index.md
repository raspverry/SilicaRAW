...
- For Phase 29 and later (service track: float color chain, LUT creation, RAW enablement, AI-assisted looks, video), use the [LUT and Video Service Master Plan](roadmaps/lut-video-service-master-plan.md) before creating new phase task cards.
...
- [LUT and Video Service Master Plan](roadmaps/lut-video-service-master-plan.md): execution router for Phase 29 through Phase 36 covering foundation hardening, the f32 color chain, manual and AI-assisted LUT creation, RAW enablement, and LUT-first video support.
...
- [Phase 18 Summary](phases/phase-18-summary.md): compact completed Phase 18 context.
- [Phase 19 Manual Masks Brief](phases/phase-19-manual-masks.md): completed manual mask scope and task order.
