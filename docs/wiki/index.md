...
- The Phase 29-36 implementation route is active while distribution remains blocked. Use the [LUT and Video Service Master Plan](roadmaps/lut-video-service-master-plan.md): Task 29.0 accepted its charter in ADR 0011, Task 29.1 is complete, Task 29.2 is the default next sequential product-development task, and other Phase 29 branches remain governed by the existing DAG.
