...
Tasks 29.0 and 29.1 are complete. Task 29.2 is the default next sequential product-development task; other branches may start only when the existing Phase 29 DAG permits them. Phase 30 waits for all Phase 29 tasks.
