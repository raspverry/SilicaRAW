...
Name: image
Version: 0.25.6
Purpose: JPEG/PNG/TIFF raster decode and export for the local alpha export path, ICC embedding for JPEG, JPEG thumbnail, Loupe preview, Develop preview cache generation, import-time JPEG dimension inspection, and raster fixture inspection in integration tests.
License: MIT OR Apache-2.0
...
Verification source: `cargo info image@0.25.6`, local Cargo metadata after Phase 5.4 and Task 20.2, Task 5.4 export tests, Task 5.6.4 thumbnail cache tests, Task 5.6.5 Loupe preview cache tests, Task 5.6.6 Develop preview tests, Task 11.7.3 metadata import tests, Task 13.6 ICC export tests, and Task 20.2 PNG/TIFF export tests.
```
